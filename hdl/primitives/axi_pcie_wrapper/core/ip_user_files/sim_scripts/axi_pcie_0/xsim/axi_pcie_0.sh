...
xv_path="/home/user/Xilinx/Vivado/2017.2"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L lib_pkg_v1_0_2 -L fifo_generator_v13_1_4 -L lib_fifo_v1_0_8 -L blk_mem_gen_v8_3_6 -L lib_bmg_v1_0_8 -L axi_pcie_v2_8_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_pcie_0 xil_defaultlib.axi_pcie_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim axi_pcie_0 -key {Behavioral:sim_1:Functional:axi_pcie_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/user/Xilinx/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_pcie_0.wdb xsim.dir)
